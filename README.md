...
Currently uses **Google's Gemini 2.5 Flash** model for optimal performance:
...
1. **Gemini over OpenAI**: Uses Google AI Studio with function calling support
...
**Built with ❤️ using Python, Gemini, and uv**
